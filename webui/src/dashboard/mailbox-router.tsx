...
import { MailboxAccountsRoute, MailboxInboxRoute, MailboxIndexRoute, MailboxOverviewRoute, MailboxPage } from './mailbox-page';
  ...
  return createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: 'accounts', Component: MailboxAccountsRoute },
