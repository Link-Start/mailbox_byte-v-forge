...
func loadConfig() config {
	...
	return config{
		...
		browserAutomationAddr:  envx.StringDefault("MAILBOX_BROWSER_AUTOMATION_ADDR", ""),
		...
		recentEmailCachePrefix: envx.StringDefault("MAILBOX_RECENT_EMAIL_CACHE_KEY_PREFIX", "mailbox:recent-email"),
